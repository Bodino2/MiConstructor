...
function layout(config: AppConfig, input: {
  ...
  return `<!doctype html><html lang="es"><head>
    ...
    <link rel="stylesheet" href="/styles.css" /><link rel="stylesheet" href="/site-shell.css" /><link rel="stylesheet" href="/guide.css" />
    ${jsonLd}
  </head><body>
    <header class="topbar"><a class="brand" href="/"><img src="/miconstructor-mark.svg" alt="" /><span>MiConstructor</span></a><nav id="main-nav" aria-label="Navegación principal"><a href="/">Inicio</a><a href="/guia">Guía y precios</a><a href="/para-profesionales">Para profesionales</a><a href="/login">Entrar</a><a class="primary" href="/registro-cliente">Publicar proyecto</a></nav></header>
